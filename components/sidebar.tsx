...
const links = [
  ...
  { href: '/experience', label: 'Experience', icon: ZpBriefcaseIcon },
...
const social = [
  ...
  {
    name: 'LinkedIn',
    url: 'https://linkedin.com/in/bravo68web',
    label: 'LinkedIn',
    icon: ZpBrandLinkedIn,
  },
  {
    name: 'Email',
    url: 'mailto:hi@b68.dev',
    label: 'Email',
    icon: ZpMailIcon,
  },
]
...
export function Sidebar({ className }: { className?: string }) {
  ...
  return (
    <aside
      className={clsxm(
        'fixed top-0 md:left-4 lg:left-[calc(50%-(3*var(--gutter-width))-(2*var(--spacing)*48))] md:mx-0 md:w-55 md:flex-shrink-0 md:px-0',
